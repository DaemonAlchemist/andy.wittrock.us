...
const MinecraftToMaxPart3Component = (props:IPageComponentProps) =>
    <>
        <p><DropCap preview={props.preview}>N</DropCap>ow that the time-consuming hassles of the holidays, hard drive crashes, new computers, and new jobs are out of the way, I finally have time to work on the Minecraft exporter again.  I dusted off the project a few days ago, and found that despite not working on the exporter since the Halloween update, it still mostly worked.  It only required a few minor changes to exclude the Nether chunk files.</p>
