...
const GravityComponent = () =>
    <>
        <p><DropCap>Y</DropCap>ears ago, when I was still in college and had lots of free time, I played around with physics simulations of various kinds.  One that most programmers try at some point is a classic gravitational simulation.  It's great fun to setup complex arrangements of planets and stars, turn on the simulation, and watch star systems evolve.</p>
